...
`timescale 1 ps / 1 ps
module qsys_led_mm_interconnect_0 (
		...
		input  wire        sin_reset_reset_bridge_in_reset_reset,          //          sin_reset_reset_bridge_in_reset.reset
		...
		output wire [1:0]  sin_s1_address,                                 //                                   sin_s1.address
		input  wire [31:0] sin_s1_readdata                                 //                                         .readdata
	);
	...
	wire   [31:0] sin_s1_agent_m0_readdata;                                           // sin_s1_translator:uav_readdata -> sin_s1_agent:m0_readdata
	wire          sin_s1_agent_m0_waitrequest;                                        // sin_s1_translator:uav_waitrequest -> sin_s1_agent:m0_waitrequest
	wire          sin_s1_agent_m0_debugaccess;                                        // sin_s1_agent:m0_debugaccess -> sin_s1_translator:uav_debugaccess
	wire   [31:0] sin_s1_agent_m0_address;                                            // sin_s1_agent:m0_address -> sin_s1_translator:uav_address
	wire    [3:0] sin_s1_agent_m0_byteenable;                                         // sin_s1_agent:m0_byteenable -> sin_s1_translator:uav_byteenable
	wire          sin_s1_agent_m0_read;                                               // sin_s1_agent:m0_read -> sin_s1_translator:uav_read
	wire          sin_s1_agent_m0_readdatavalid;                                      // sin_s1_translator:uav_readdatavalid -> sin_s1_agent:m0_readdatavalid
	wire          sin_s1_agent_m0_lock;                                               // sin_s1_agent:m0_lock -> sin_s1_translator:uav_lock
	wire   [31:0] sin_s1_agent_m0_writedata;                                          // sin_s1_agent:m0_writedata -> sin_s1_translator:uav_writedata
	wire          sin_s1_agent_m0_write;                                              // sin_s1_agent:m0_write -> sin_s1_translator:uav_write
	wire    [2:0] sin_s1_agent_m0_burstcount;                                         // sin_s1_agent:m0_burstcount -> sin_s1_translator:uav_burstcount
	wire          sin_s1_agent_rf_source_valid;                                       // sin_s1_agent:rf_source_valid -> sin_s1_agent_rsp_fifo:in_valid
	wire  [102:0] sin_s1_agent_rf_source_data;                                        // sin_s1_agent:rf_source_data -> sin_s1_agent_rsp_fifo:in_data
	wire          sin_s1_agent_rf_source_ready;                                       // sin_s1_agent_rsp_fifo:in_ready -> sin_s1_agent:rf_source_ready
	wire          sin_s1_agent_rf_source_startofpacket;                               // sin_s1_agent:rf_source_startofpacket -> sin_s1_agent_rsp_fifo:in_startofpacket
	wire          sin_s1_agent_rf_source_endofpacket;                                 // sin_s1_agent:rf_source_endofpacket -> sin_s1_agent_rsp_fifo:in_endofpacket
	wire          sin_s1_agent_rsp_fifo_out_valid;                                    // sin_s1_agent_rsp_fifo:out_valid -> sin_s1_agent:rf_sink_valid
	wire  [102:0] sin_s1_agent_rsp_fifo_out_data;                                     // sin_s1_agent_rsp_fifo:out_data -> sin_s1_agent:rf_sink_data
	wire          sin_s1_agent_rsp_fifo_out_ready;                                    // sin_s1_agent:rf_sink_ready -> sin_s1_agent_rsp_fifo:out_ready
	wire          sin_s1_agent_rsp_fifo_out_startofpacket;                            // sin_s1_agent_rsp_fifo:out_startofpacket -> sin_s1_agent:rf_sink_startofpacket
	wire          sin_s1_agent_rsp_fifo_out_endofpacket;                              // sin_s1_agent_rsp_fifo:out_endofpacket -> sin_s1_agent:rf_sink_endofpacket
	wire          cmd_mux_001_src_valid;                                              // cmd_mux_001:src_valid -> sin_s1_agent:cp_valid
	wire  [101:0] cmd_mux_001_src_data;                                               // cmd_mux_001:src_data -> sin_s1_agent:cp_data
	wire          cmd_mux_001_src_ready;                                              // sin_s1_agent:cp_ready -> cmd_mux_001:src_ready
	wire    [1:0] cmd_mux_001_src_channel;                                            // cmd_mux_001:src_channel -> sin_s1_agent:cp_channel
	wire          cmd_mux_001_src_startofpacket;                                      // cmd_mux_001:src_startofpacket -> sin_s1_agent:cp_startofpacket
	wire          cmd_mux_001_src_endofpacket;                                        // cmd_mux_001:src_endofpacket -> sin_s1_agent:cp_endofpacket
	...
	wire          sin_s1_agent_rp_valid;                                              // sin_s1_agent:rp_valid -> router_002:sink_valid
	wire  [101:0] sin_s1_agent_rp_data;                                               // sin_s1_agent:rp_data -> router_002:sink_data
	wire          sin_s1_agent_rp_ready;                                              // router_002:sink_ready -> sin_s1_agent:rp_ready
	wire          sin_s1_agent_rp_startofpacket;                                      // sin_s1_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire          sin_s1_agent_rp_endofpacket;                                        // sin_s1_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	wire          sin_s1_agent_rdata_fifo_src_valid;                                  // sin_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire   [33:0] sin_s1_agent_rdata_fifo_src_data;                                   // sin_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire          sin_s1_agent_rdata_fifo_src_ready;                                  // avalon_st_adapter_001:in_0_ready -> sin_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_001_out_0_valid;                                  // avalon_st_adapter_001:out_0_valid -> sin_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_001_out_0_data;                                   // avalon_st_adapter_001:out_0_data -> sin_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_001_out_0_ready;                                  // sin_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire    [0:0] avalon_st_adapter_001_out_0_error;                                  // avalon_st_adapter_001:out_0_error -> sin_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_0_clk_clk),                         //                      clk.clk
		.reset                  (sin_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (sin_s1_agent_m0_address),               // avalon_universal_slave_0.address
		.uav_burstcount         (sin_s1_agent_m0_burstcount),            //                         .burstcount
		.uav_read               (sin_s1_agent_m0_read),                  //                         .read
		.uav_write              (sin_s1_agent_m0_write),                 //                         .write
		.uav_waitrequest        (sin_s1_agent_m0_waitrequest),           //                         .waitrequest
		.uav_readdatavalid      (sin_s1_agent_m0_readdatavalid),         //                         .readdatavalid
		.uav_byteenable         (sin_s1_agent_m0_byteenable),            //                         .byteenable
		.uav_readdata           (sin_s1_agent_m0_readdata),              //                         .readdata
		.uav_writedata          (sin_s1_agent_m0_writedata),             //                         .writedata
		.uav_lock               (sin_s1_agent_m0_lock),                  //                         .lock
		.uav_debugaccess        (sin_s1_agent_m0_debugaccess),           //                         .debugaccess
		.av_address             (sin_s1_address),                        //      avalon_anti_slave_0.address
		.av_readdata            (sin_s1_readdata),                       //                         .readdata
		.av_write               (),                                      //              (terminated)
		.av_read                (),                                      //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                           //             clk.clk
		.reset                   (sin_reset_reset_bridge_in_reset_reset),   //       clk_reset.reset
		.m0_address              (sin_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (sin_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (sin_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (sin_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (sin_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (sin_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (sin_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (sin_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (sin_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (sin_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (sin_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (sin_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (sin_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (sin_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (sin_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (sin_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (sin_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (sin_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (sin_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (sin_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (sin_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (sin_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (sin_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (sin_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (sin_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (sin_s1_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_001_out_0_ready),       // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_001_out_0_valid),       //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_001_out_0_data),        //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_001_out_0_error),       //                .error
		.rdata_fifo_src_ready    (sin_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (sin_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (sin_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                   //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                     //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) sin_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                           //       clk.clk
		.reset             (sin_reset_reset_bridge_in_reset_reset),   // clk_reset.reset
		.in_data           (sin_s1_agent_rf_source_data),             //        in.data
		.in_valid          (sin_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (sin_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (sin_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (sin_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (sin_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (sin_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (sin_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (sin_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (sin_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                   // (terminated)
		.csr_read          (1'b0),                                    // (terminated)
		.csr_write         (1'b0),                                    // (terminated)
		.csr_readdata      (),                                        // (terminated)
	...
	qsys_led_mm_interconnect_0_router router (
	...
	qsys_led_mm_interconnect_0_router_001 router_001 (
	...
	qsys_led_mm_interconnect_0_router_001 router_002 (
		.sink_ready         (sin_s1_agent_rp_ready),                 //      sink.ready
		.sink_valid         (sin_s1_agent_rp_valid),                 //          .valid
		.sink_data          (sin_s1_agent_rp_data),                  //          .data
		.sink_startofpacket (sin_s1_agent_rp_startofpacket),         //          .startofpacket
		.sink_endofpacket   (sin_s1_agent_rp_endofpacket),           //          .endofpacket
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (sin_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	qsys_led_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                 //        clk.clk
		.reset              (led_reset_reset_bridge_in_reset_reset),         //  clk_reset.reset
	...
	qsys_led_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (led_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	qsys_led_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (sin_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	qsys_led_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (led_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	qsys_led_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (sin_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	qsys_led_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (led_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	qsys_led_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
	...
	qsys_led_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                         // in_clk_0.clk
		.in_rst_0_reset (sin_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (sin_s1_agent_rdata_fifo_src_data),      //     in_0.data
		.in_0_valid     (sin_s1_agent_rdata_fifo_src_valid),     //         .valid
		.in_0_ready     (sin_s1_agent_rdata_fifo_src_ready),     //         .ready
